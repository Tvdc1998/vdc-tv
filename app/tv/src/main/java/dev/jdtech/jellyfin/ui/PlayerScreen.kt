...
import com.vdc.tv.ui.components.player.VideoPlayerControlsLayout
import com.vdc.tv.ui.components.player.VideoPlayerMediaButton
import com.vdc.tv.ui.components.player.VideoPlayerMediaTitle
import com.vdc.tv.ui.components.player.VideoPlayerOverlay
import com.vdc.tv.ui.components.player.VideoPlayerSeeker
import com.vdc.tv.ui.components.player.VideoPlayerState
        ...
        VideoPlayerOverlay(
            ...
            controls = {
                VideoPlayerControls(
                    ...
                    state = videoPlayerState,
                    focusRequester = focusRequester,
                    onSubtitleDownloadClick = { showSubtitleDownloadDialog = true }
                    // navigator = navigator,
                )
            },
        )
    ...
    if (showSubtitleDownloadDialog) {
        SubtitleDownloadDialog(
            ...
            onSubtitleDownloaded = { url, title, language ->
                viewModel.addSubtitle(url, title, language)
            },
            onDismissRequest = { showSubtitleDownloadDialog = false }
        )
    }
}
