    ...
    Row(
        ...
        Surface(
            ...
            Row(
                ...
                Icon(
                    painter = painterResource(CoreR.drawable.ic_logo_source),
            ...
            Surface(
                ...
                Box(modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) {
                    ...
                    user?.let {
                        ...
                        AsyncImage(
                            model = "$baseUrl/users/${user.id}/Images/${ImageType.PRIMARY}${if (user.primaryImageTag != null) "?tag=${user.primaryImageTag}" else ""}",
                            contentDescription = null,
