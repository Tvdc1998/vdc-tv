...
import com.vdc.tv.presentation.player.SpeedSelectionDialogFragment
import com.vdc.tv.presentation.player.SubtitleDownloadBottomSheetFragment
import com.vdc.tv.presentation.player.TrackSelectionDialogFragment
...
class PlayerActivity : BasePlayerActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val subtitleDownloadButton = binding.playerView.findViewById<ImageButton>(R.id.btn_subtitle_download)
        ...
        subtitleDownloadButton.setOnClickListener {
            SubtitleDownloadBottomSheetFragment.newInstance(itemId)
                .show(supportFragmentManager, "subtitledownloadbottomsheet")
        }
