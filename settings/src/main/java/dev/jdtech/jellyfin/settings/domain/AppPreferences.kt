...
class AppPreferences @Inject constructor(val sharedPreferences: SharedPreferences) {
    ...
    val homeGenreAction = Preference<Boolean>("home_genre_action", false)
    val homeGenreComedy = Preference<Boolean>("home_genre_comedy", false)
    val homeGenreDrama = Preference<Boolean>("home_genre_drama", false)
    val homeGenreHorror = Preference<Boolean>("home_genre_horror", false)
    val homeGenreAnimation = Preference<Boolean>("home_genre_animation", false)
    val homeGenreKids = Preference<Boolean>("home_genre_kids", false)
