...
import com.vdc.tv.settings.presentation.models.PreferenceAppLanguage
                                    ...
                                    PreferenceGroup(
                                        ...
                                        preferences =
                                            listOf(
                                                ...
                                                PreferenceSwitch(
                                                    nameStringResource = R.string.home_genre_action,
                                                    backendPreference = appPreferences.homeGenreAction,
                                                ),
                                                PreferenceSwitch(
                                                    nameStringResource = R.string.home_genre_comedy,
                                                    backendPreference = appPreferences.homeGenreComedy,
                                                ),
                                                PreferenceSwitch(
                                                    nameStringResource = R.string.home_genre_drama,
                                                    backendPreference = appPreferences.homeGenreDrama,
                                                ),
                                                PreferenceSwitch(
                                                    nameStringResource = R.string.home_genre_horror,
                                                    backendPreference = appPreferences.homeGenreHorror,
                                                ),
                                                PreferenceSwitch(
                                                    nameStringResource = R.string.home_genre_animation,
                                                    backendPreference = appPreferences.homeGenreAnimation,
                                                ),
                                                PreferenceSwitch(
                                                    nameStringResource = R.string.home_genre_kids,
                                                    backendPreference = appPreferences.homeGenreKids,
                                                ),
                                            ),
                                    ),
                                    PreferenceGroup(
